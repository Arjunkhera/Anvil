 ...
 */
export function validateNote(frontmatter, type, mode = 'strict') {
    const errors = [];
    const warnings = [];
    ...
    for (const [fieldName, fieldDef] of Object.entries(type.fields)) {
        ...
        const fieldErrors = validateField(fieldName, value, fieldDef, frontmatter, mode);
 ...
 */
function validateField(fieldName, value, fieldDef, frontmatter, mode) {
    const errors = [];
            ...
            if (fieldDef.fields) {
                ...
                for (const [nestedName, nestedDef] of Object.entries(fieldDef.fields)) {
                    ...
                    if (nestedValue === undefined || nestedValue === null) {
                        ...
                        const nestedErrors = validateField(`${fieldName}.${nestedName}`, nestedValue, nestedDef, objVal, mode);

...
export class AnvilDb {
    ...
    getOne(sql, params) {
        const result = this.sqlDb.get(sql, params);
        return result ?? null;
    }
    /** Execute a SELECT and return all rows */
    getAll(sql, params) {
        return this.sqlDb.all(sql, params);
    }
...
export class AnvilDatabase {
    ...
    upsertType(type) {
        this._db.run(`INSERT INTO types (type_id, name, schema_json, template_json, updated_at)
       VALUES (?, ?, ?, ?, ?)

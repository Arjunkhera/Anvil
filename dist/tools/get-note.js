 ...
 */
export async function handleGetNote(input, ctx) {
    try {
        ...
        return makeError(ERROR_CODES.SERVER_ERROR, `Unexpected error retrieving note: ${err instanceof Error ? err.message : String(err)}`);
    }
}
